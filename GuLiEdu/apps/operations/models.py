...
class UserLove(models.Model):
    love_man=models.ForeignKey('users.UserProfile',verbose_name='收藏人',on_delete=models.CASCADE)
...
class UserCourse(models.Model):
    study_man = models.ForeignKey('users.UserProfile', verbose_name='学习人', on_delete=models.CASCADE)
    study_course=models.ForeignKey('courses.CourseInfo',verbose_name='学习课程',on_delete=models.CASCADE)
    add_time = models.DateTimeField(default=datetime.now, verbose_name='添加时间')
    def __str__(self):
...
class UserComment(models.Model):
    comment_man = models.ForeignKey('users.UserProfile', verbose_name='评论人', on_delete=models.CASCADE)
    comment_course = models.ForeignKey('courses.CourseInfo', verbose_name='评论课程', on_delete=models.CASCADE)
